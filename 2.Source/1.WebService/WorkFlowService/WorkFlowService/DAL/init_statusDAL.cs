...
namespace Saron.WorkFlowService.DAL
{
    ...
    /// 数据访问类:init_status
    /// </summary>
    public class init_statusDAL
    {
        public init_statusDAL()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "init_status"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from init_status");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into init_status(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update init_status set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from init_status ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
		...
		public Saron.WorkFlowService.Model.init_statusModel GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,name,code,remark from init_status ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;

            Saron.WorkFlowService.Model.init_statusModel model = new Saron.WorkFlowService.Model.init_statusModel();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM init_status ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from init_status T ");
